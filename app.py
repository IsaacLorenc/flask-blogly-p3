...
def root():
    ...
    return render_template('posts/homepage.html, posts=post')
...
def users_new():
    '''Creates a new user and adds them to list'''
...
def users_edit(user_id):
    '''Shows form to edit existing user'''
...
def users_update(user_id):
    '''Form submission for updating exsiting user'''
